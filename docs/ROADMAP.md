...
- strict C89 host build passes
- deterministic 320x200 framebuffer preview is generated
- DOS source/build target is ready for Open Watcom

Remaining integration check: compile and run `CHESSFRT.EXE` under Open Watcom + DOSBox.
