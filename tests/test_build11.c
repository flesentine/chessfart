...
static void test_layout_contract(void)
{
    ...
    CHECK(CF_UI_TITLE_ITEM_ATTRACT == 2);
    CHECK(CF_UI_TITLE_ITEM_HELP == 3);
    CHECK(CF_UI_TITLE_ITEM_CREDITS == 4);
    CHECK(CF_UI_TITLE_ITEM_QUIT == 5);
    CHECK(CF_UI_TITLE_ITEM_QUIT + 1 == CF_UI_TITLE_MENU_ITEM_COUNT);
    CHECK(CF_UI_TITLE_MENU_ITEM_COUNT == 6);
