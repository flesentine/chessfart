...
- 36 native 320x200 visual-review states covering CPU/local HUDs, Fart, promotion, terminal states, exact theme switch/restore proof, and the real Crimson authored board-surface path
